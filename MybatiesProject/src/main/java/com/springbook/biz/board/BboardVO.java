...
//	 현재페이지, 시작페이지, 끝페이지, 게시글 총 갯수, 페이지당 글 갯수, 마지막페이지, SQL쿼리에 쓸 start, end
	...
	public String toString() {
		return "BboardVO [seq=" + seq + ", cnt=" + cnt + ", title=" + title + ", writer=" + writer + ", content="
				+ content + ", searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", regdate="
				+ regdate + ", auto=" + auto + ", highestSeq=" + highestSeq + ", total=" + total + ", s]";
	}
	...
	public BboardVO(int total, int nowPage, int cntPerPage, int offset) {
		setNowPage(nowPage);
